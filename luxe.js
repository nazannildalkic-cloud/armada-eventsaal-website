...
window.openModal = function (type) {
    ...
    if (type === 'impressum') {
        ...
        const map = {
            de: '<h3 style="margin-bottom:20px;">Datenschutzerklärung</h3><p>Der Schutz Ihrer persönlichen Daten hat für uns höchste Priorität. Die über das Kontaktformular übermittelten Angaben verwenden wir ausschließlich zur Bearbeitung Ihrer Anfrage.</p><p style="margin-top:15px;">Ihre Daten werden über eine verschlüsselte Verbindung an unser internes System übermittelt und nicht an unbefugte Dritte weitergegeben.</p><p style="margin-top:15px;">Sie haben jederzeit das Recht auf Auskunft, Berichtigung oder Löschung Ihrer Daten. Kontakt: info@armada-events.de</p>',
